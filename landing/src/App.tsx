...
function Eyebrow({ children }: { children: ReactNode }) {
  return <h2 className="eyebrow"><i className="eyebrow-mark" aria-hidden="true" /><span>{children}</span></h2>
}
...
function SectionHead({ eyebrow, title, text, center = false }: { eyebrow: string; title: ReactNode; text: string; center?: boolean }) {
  return <Reveal className={`section-head ${center ? 'center' : ''}`}><Eyebrow>{eyebrow}</Eyebrow><div className="section-statement">{title}</div><p>{text}</p></Reveal>
}
  ...
  return <>
    ...
    <main id="main">
      <section className="hero" id="top">
        <div className="hero-border-orbits" aria-hidden="true"><i /><i /><i /></div>
      ...
      <section className="overview section" id="overview">
        <div className="container">
          <SectionHead eyebrow="چرا بیلدینو؟" title={<>راهکاری مدرن برای<br /><em>مدیریت ساختمان و مجتمع‌ها</em></>} text="بیلدینو با ترکیب فناوری و خدمات حرفه‌ای، کارهای پراکنده ساختمان را در یک مسیر مشخص جمع می‌کند؛ نتیجه، صرفه‌جویی در زمان و هزینه، شفافیت مالی، ارتباط بهتر مدیر و ساکنان، دسترسی سریع به خدمات و افزایش ارزش ساختمان است." />
        ...
        <div className="container">
          ...
          <div className="bento-grid">
            <Reveal className="bento bento-context">
              <div className="bento-copy"><span className="bento-icon"><Icon name="building" /></span><small>همه اطلاعات، در یک نگاه</small><h3>همه واحدها، با دسترسی مخصوص خودشان</h3><p>مجتمع، بلوک، واحد، مالک، مستأجر و ساکنان را یک‌جا مدیریت کنید؛ اسناد، ورود و خروج، اطلاعیه‌ها و ارتباطات داخلی نیز برای هر نقش در دسترس است. ساختمان شما در دستان شماست.</p><ul><li>پنل مدیر، مالک و مستأجر</li><li>اطلاعات مستقل هر واحد</li><li>اسناد و دسترسی‌های مرتبط</li></ul></div>
      ...
      <section className="services section" id="services">
        <div className="container">
          <SectionHead eyebrow="خدمات ساختمان و واحد" title={<>هر خدمتی که نیاز دارید؛<br /><em>در دسترس و قابل پیگیری</em></>} text="برای تعمیرات، نظافت یا خدمات فوری نوع خدمت را انتخاب کنید، درخواستتان را ثبت کنید و هماهنگی با پیمانکاران موردتأیید را تا پایان کار دنبال کنید." />
          <div className="services-grid">
            <Reveal className="service-catalog">
              ...
              <div className="service-cards">
                ...
                <article className="service-card"><span><Icon name="building" /></span><div><h4>آسانسور و تجهیزات</h4><p>رفع خرابی آسانسور، موتورخانه و تجهیزات مشترک ساختمان</p></div><Icon name="chevron" size={18} /></article>
                <article className="service-card"><span><Icon name="layers" /></span><div><h4>نظافت و محوطه</h4><p>نظافت ساختمان، فضای سبز و رسیدگی به فضاهای مشترک</p></div><Icon name="chevron" size={18} /></article>
                <article className="service-card"><span><Icon name="activity" /></span><div><h4>بازسازی و خدمات فوری</h4><p>خدمات بازسازی و رسیدگی سریع به درخواست‌های ضروری</p></div><Icon name="chevron" size={18} /></article>
              </div>
      ...
      <section className="quality section" id="maintenance">
        <div className="container quality-shell">
          <Reveal className="quality-copy"><Eyebrow>نگهداری و بهره‌برداری</Eyebrow><div className="section-statement">عملکرد بهتر،<br /><em>عمر بیشتر ساختمان</em></div><p>بیلدینو به مدیران ساختمان کمک می‌کند نگهداری و سرویس‌های دوره‌ای را حرفه‌ای مدیریت کنند؛ از ثبت درخواست و سوابق تعمیرات تا کنترل پیمانکاران و برنامه‌ریزی پیشگیرانه. نگهداری هوشمند برای ساختمانی مطمئن.</p></Reveal>
          <div className="quality-list">
            <Reveal className="quality-item" delay={60}><Icon name="activity" /><div><b>درخواست‌های نگهداری</b><small>ثبت درخواست و پیگیری روند انجام</small></div></Reveal>
            <Reveal className="quality-item" delay={110}><Icon name="calendar" /><div><b>سرویس‌های دوره‌ای</b><small>مدیریت زمان‌بندی و یادآوری سرویس</small></div></Reveal>
            <Reveal className="quality-item" delay={160}><Icon name="building" /><div><b>تجهیزات و سوابق تعمیرات</b><small>مدیریت تجهیزات و ثبت سابقه هر تعمیر</small></div></Reveal>
            <Reveal className="quality-item" delay={210}><Icon name="layers" /><div><b>کنترل و پیشگیری</b><small>پیمانکاران، چک‌لیست بازرسی و خدمات پیشگیرانه</small></div></Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="benefits section">
        <div className="container">
          ...
          <div className="benefit-grid">
            ...
            <Reveal className="benefit" delay={210}><span>۴</span><h3>همیشه در ارتباط، همیشه آگاه</h3><p>اطلاعیه‌های مجتمع، پاسخ پشتیبانی و تغییر وضعیت درخواست‌ها را به‌موقع دریافت کنید.</p></Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta section">
        <div className="container">
          <Reveal className="cta-shell">
            ...
            <div className="cta-copy"><Eyebrow>خدمات ویژه و سازمانی</Eyebrow><div className="section-statement">ساختمان هوشمند،<br />آینده روشن‌تر</div><p>فراتر از یک اپلیکیشن؛ خرید بیمه ساختمان و خودرو، پرداخت اقساطی و تسهیلات، خدمات ویژه مجتمع‌ها، همکاری با پیمانکاران تأییدشده، نسخه سازمانی مجتمع‌های بزرگ و قابلیت توسعه خدمات آینده.</p><div><a href="#showcase" className="button button-light">داخل محصول را ببینید <Icon name="arrow" size={19} /></a><a href="#capabilities" className="cta-link">مدیریت ساختمان و ساکنان </a></div></div>
          </Reveal>
        </div>
      </section>
    </main>
    <footer className="site-footer">
      <img className="footer-skyline" src="/images/milad-tower.png" alt="" aria-hidden="true" />
